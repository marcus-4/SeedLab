...
while(cap_left.isOpened()):
    ...
    #hardcoded width and height for angle ratio
    ww = 0.5*627
    hh = 0.5*466
    ...
    #detection
    #detect markers and draw box over it
    ...
    try:
        ...
        #angx and far set to 0 to not confuse code
        angx = int(0)
        angy = 0
        far = int(0)
        search = int(1)
